...
- **App + Shared** — ~11 000 строк; появился таргет **`CheckNetTests` (81 тест)** на логику
...
**Статус вех:** M1 ✅ · M2 ✅ · M3 ✅ · M4 ✅ · M5 в работе (#41, #42, #43 ✅) · M6 ✅ (инструменты сделаны; #49 — живой бэклог идей).
