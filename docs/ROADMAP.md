...
- **23 инструмента** реализованы (движок протестирован + экран), **4 — заглушки «скоро»**
  (`App/Catalog/Tool.swift`): геолокация IP, Wi-Fi-анализ, сигнал Wi-Fi, World Ping.
  Секция «Wi-Fi» в каталоге пуста целиком. Bufferbloat (#46) переехал из заглушек в готовые.
...
**Статус вех:** M1 ✅ · M2 ✅ · M3 ✅ · M4 ✅ · M5 запланирована · M6 в работе (#46 сделан).
