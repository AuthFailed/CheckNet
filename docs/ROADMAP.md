...
- **App + Shared** — ~11 000 строк; появился таргет **`CheckNetTests` (64 теста)** на логику
...
**Статус вех:** M1 ✅ · M2 ✅ · M3 ✅ · M4 ✅ · M5 в работе (#42 ✅) · M6 ✅ (инструменты сделаны; #49 — живой бэклог идей).
