...
- **25 инструментов** реализованы (движок протестирован + экран), **2 — заглушки «скоро»**
  (`App/Catalog/Tool.swift`): Wi-Fi-анализ и сигнал Wi-Fi (оба iOS-ограничены, доступны на Mac).
  Готовы: bufferbloat (#46), геолокация IP и World Ping (#47).
