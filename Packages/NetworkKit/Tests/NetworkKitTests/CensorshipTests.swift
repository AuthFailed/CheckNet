...
final class CensorshipTests: XCTestCase {
    ...
    func testDNSSpoofingCleanNetwork() async throws {
        try requiresInternet()
    ...
    func testIPBlockingControlReachable() async throws {
        try requiresInternet()
    ...
    func testSNICleanNetwork() async throws {
        try requiresInternet()
    ...
    func testWhitelistCleanNetwork() async throws {
        try requiresInternet()
    ...
    func testHTTPBlockPageCleanNetwork() async throws {
        try requiresInternet()
